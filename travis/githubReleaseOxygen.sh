...
NEWFILES[$n]='GAMA1.8_photon_Linux_32'$SUFFIX
n=1
RELEASEFILES[$n]="$thePATH-linux.gtk.x86_64.zip"
NEWFILES[$n]='GAMA1.8_photon_Linux_64'$SUFFIX
n=2
RELEASEFILES[$n]="$thePATH-macosx.cocoa.x86_64.zip"
NEWFILES[$n]='GAMA1.8_photon_Mac_64'$SUFFIX
n=3
RELEASEFILES[$n]="$thePATH-win32.win32.x86.zip"
NEWFILES[$n]='GAMA1.8_photon_Win_32'$SUFFIX
n=4
RELEASEFILES[$n]="$thePATH-win32.win32.x86_64.zip" 
NEWFILES[$n]='GAMA1.8_photon_Win_64'$SUFFIX
